...
export default function WikiNotFound() {
  return (
    <main className="mx-auto max-w-xl py-12 text-center">
      ...
      <Link
        href="/wiki"
        className="mt-7 inline-flex min-h-11 items-center gap-2 rounded-full border border-zinc-700 px-5 text-sm text-zinc-100 transition-colors hover:border-brand-400 hover:text-brand-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400"
      >
