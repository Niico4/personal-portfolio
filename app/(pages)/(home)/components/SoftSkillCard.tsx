    ...
    >
      <CardHeader className="gap-4 p-0">
        <div className="rounded-xl bg-white/[0.08] p-2.5 ring-1 ring-white/[0.06]">
          <Icon size={22} color="#ffffff" stroke={1.5} className="opacity-80" />
        </div>
        <h3 className="text-xl font-medium text-subtitle/85">{title}</h3>
      </CardHeader>
      <CardBody className="p-0">
        <p className="text-sm md:text-base text-soft leading-relaxed tracking-wide">
          {description}
        </p>
      </CardBody>
    </Card>
